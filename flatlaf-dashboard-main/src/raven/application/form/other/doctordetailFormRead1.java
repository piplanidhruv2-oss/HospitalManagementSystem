 ...
 * @author Raven
 */
public class doctordetailFormRead1 extends javax.swing.JPanel {

    public doctordetailFormRead1() {
        initComponents();
        String query = "select * from doctor_details;"; // Replace with your SQL query
        try {
            ...
            DoctTable.setModel(DbUtils.resultSetToTableModel(resultSet));
...
//                while (resultSet.next()) {
    ...
    private void initComponents() {
        ...
        DoctTable = new javax.swing.JTable();
        updatebutton = new javax.swing.JButton();

        lb.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lb.setText("Doctor-Details");
        ...
        DoctTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Name", " Mobile Number", "Specialist", "Date", "Residential Address", "Addhaar Number", "Medical License Number"
            }
        ));
        jScrollPane1.setViewportView(DoctTable);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lb, javax.swing.GroupLayout.DEFAULT_SIZE, 1188, Short.MAX_VALUE)
    ...
    private javax.swing.JTable DoctTable;
