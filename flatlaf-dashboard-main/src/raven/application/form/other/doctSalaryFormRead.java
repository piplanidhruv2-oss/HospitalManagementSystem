 ...
 * @author Raven
 */
public class doctSalaryFormRead extends javax.swing.JPanel {

    public doctSalaryFormRead() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lb.setText("Doctor-Salary Details");

        jLabel1.setText("Medical LicenseNumber");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medical License Number", "Name", "Date", "Basic Pay", "Allowence", "Overtime", "Health Insurance", "bonuses", "Total "
            }
        ));
