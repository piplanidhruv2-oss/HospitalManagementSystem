...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Dashboard"}, // 1
        {"~WEB APP~"}, //2
        {"Patient", "New Patient", "Patient Details", "Patient Report"},
        {"Appointment", "With Appointment", "Without Appointment"},
        {"Appointment Details", "View Appointments", "View Appointment"},
        {"~COMPONENT~"},
        {"Doctor", "New Doctor", "Doctor Details", "Finance"},
        {"Staff", "New Staff", "Staff Details", "Staff Salary"},
        {"~OTHER~"},
        {"Department", "Medicine", "Report Details"},
        {"Finance", "Doctor Salary List", "Staff Salary List"},
        {"PathLab", "Test and Diagonsis", "Test Report"},
        {"User", "Receptionist", "Admin", "Medicine Staff", "Pricing", "Timeline"},
        {"Logout"}
    };
